    ...
    <b-navbar toggleable="lg" type="dark" variant="info" id="navbar">
        ...
        <b-collapse id="nav-collapse" is-nav>
            ...
            <b-navbar-nav class="ml-auto">
                <RunModal></RunModal>
                <b-button style="border-right-color: #ffffff; border-radius: 0em; border-top-left-radius: 0.25em; border-bottom-left-radius: 0.25em">
                <span contenteditable="true" id="docName">{{ $t("untitled") }}</span>
                </b-button>
                <b-button id="v-step-1" :disabled="!configurationValidated" style="border-right-color: #ffffff; border-radius: 0em;" v-b-modal.run-modal>
